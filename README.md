...
| Folder | Role |
|--------|------|
| [commands/](commands/) | Slash commands (Markdown prompt recipes). For phased build plans, set `PLANNING_ROOT` in each `phased-plan-*.md` command or in repo `AGENTS.md`. See [commands/README.md](commands/README.md). |
