...
Explicit-only. Invoke with `/owcc-workflow-review`.
...
- Do not substitute for `/owcc-repo-convention-change` when the task is to **author** a new policy—this skill audits and inventories.
