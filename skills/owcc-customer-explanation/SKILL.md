---
name: owcc-customer-explanation
description: >-
  ...
  /owcc-customer-explanation or asks for a customer explanation, client reply,
...
Explicit-only. Invoke with `/owcc-customer-explanation`.
