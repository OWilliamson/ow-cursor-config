...
description: >-
  ...
  owcc-ui-convert-rules after pasting UI rules, multiple rules in one paste, or when
...
**Manual only:** `/owcc-ui-convert-rules`. Do **not** infer this workflow from ambient chat alone.
