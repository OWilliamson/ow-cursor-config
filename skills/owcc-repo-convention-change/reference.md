# owcc-repo-convention-change — reference
...
| Full agent handbook + rules audit | `owcc-workflow-review` |

## Install location

Personal (all repos): `~/.cursor/skills/owcc-repo-convention-change/`

Project copy (team shares it): copy the directory into `<repo>/.cursor/skills/owcc-repo-convention-change/` and mention it from that repo’s `AGENTS.md` if desired.
